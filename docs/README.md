...
Dokumen ini ditulis **seiring pembangunan** agar setiap keputusan tercatat.

| # | Dokumen | Isi |
|---|---------|-----|
| 01 | [Arsitektur](01-arsitektur.md) | Pola MVC, struktur folder, lapisan Service, konvensi |
| 02 | [Database & ERD](02-database-erd.md) | 9 entitas, 3 enum, relasi, deviasi dari class diagram |
