        ...
        <div class="row g-4 mb-5">
            <div class="col-md-8 mx-auto" data-reveal style="--reveal-d: 120ms">
                <div class="d-flex flex-column h-100">
                    ...
                    <h1 class="rl-page-title mb-4">{{ $produk->nama_produk }}</h1>
                    ...
                    <div class="mt-auto">
                        ...
                        <p class="rl-text-sm rl-text-muted text-center mt-3 mb-0">Transaksi dilakukan di luar sistem. Hubungi admin via WhatsApp untuk informasi lebih lanjut.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="rl-carousel-item">
                            <a href="{{ route('catalogue.show', $p) }}" class="rl-card h-100 overflow-hidden d-block text-decoration-none text-dark">
                                <div class="p-3">
                                    ...
                                    <p class="rl-text-sm rl-text-muted text-truncate mb-0">{{ $p->deskripsi_produk ?: 'Belum ada deskripsi untuk produk ini.' }}</p>
                                </div>
                            </a>
                        </div>
                    @endforeach
