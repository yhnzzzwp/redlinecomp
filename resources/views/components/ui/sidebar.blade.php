...
@php
    ...
    $nav = [
        ...
        ['pos', 'POS', '#', false, 'M3 4h18v12H3zM3 20h18'],
        ['produk', 'Products', '#', false, 'M3 7l9-4 9 4-9 4-9-4zM3 7v10l9 4 9-4V7'],
        ['analytics', 'Analytics', '#', true, 'M4 20V10M10 20V4M16 20v-7M22 20H2'],
        ['customers', 'Customers', '#', false, 'M9 8a3 3 0 100-6 3 3 0 000 6zM3 20c0-3.3 2.7-5 6-5s6 1.7 6 5'],
        ['service', 'Service', '#', false, 'M14 6a4 4 0 005 5l-8 8-3-3 6-6a4 4 0 010-4z'],
        ['promo', 'Promo', '#', true, 'M3 12l8-8h8v8l-8 8-8-8zM15 9h.01'],
        ['pegawai', 'Akun Pegawai', '#', true, 'M3 5h18v14H3zM9 12a2 2 0 100-4 2 2 0 000 4z'],
    ];
@endphp
<aside class="rl-side">
    ...
    @foreach ($nav as [$key, $label, $url, $ownerOnly, $path])
        {{-- Item khusus Owner hanya tampil bagi Owner (menu ikut enforcement, backend tetap dijaga middleware) --}}
