...
<nav x-data="{ open: false }" class="rl-pubnav flex-wrap align-items-center" role="navigation">
    ...
    <div :class="{'d-none': !open, 'd-flex': open}" class="w-100 d-md-flex align-items-center flex-column flex-md-row ms-md-4 mt-3 mt-md-0 gap-3 gap-md-4">
        ...
        <a href="{{ route('login') }}" class="ms-md-auto btn-ghost px-3 py-2 text-center mt-3 mt-md-0 w-100 w-md-auto">Login Staff</a>
    </div>
</nav>
