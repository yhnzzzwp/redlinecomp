    ...
    <div class="row g-3">
        <div class="col-6 col-lg-3">
            <div class="rl-card rl-kpi h-100">
                ...
                <div class="rl-kpi__val tnum">{{ number_format($totalSales, 0, ',', '.') }} <span class="fs-6 fw-normal text-muted">Transaksi</span></div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="rl-card rl-kpi h-100">
                ...
                <div class="rl-kpi__val tnum text-success">{{ number_format($todaySales, 0, ',', '.') }} <span class="fs-6 fw-normal text-muted">Transaksi</span></div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="rl-card rl-kpi h-100">
                ...
                <div class="rl-chart-bar-wrap">
                    @foreach ($trend as $t)
                        <div class="rl-chart-bar">
                            <div class="rl-chart-bar__fill rounded-top" title="{{ $t['label'] }}: {{ $t['total'] }} Transaksi"
                ...
                <div class="px-2 pb-2">
                    @forelse ($recent as $t)
                        <div class="d-flex align-items-center justify-content-between px-2 py-2 border-bottom rl-divider-light">
                            ...
                            <div class="text-end">
                                <div class="fw-bold tnum rl-text-sm">{{ $t->item_transaksi_count ?? 0 }} Item</div>
