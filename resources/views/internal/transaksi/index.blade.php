        ...
        <table class="rl-table">
            ...
            <tbody>
                @forelse ($transaksi as $t)
                    <tr>
                        <td>
                            <div class="fw-semibold rl-mono">#{{ $t->kode_nota }}</div>
